...
public class Movement : MonoBehaviour
{
    ...
    public float bulletMaxDistance = 5f;
    ...
    private void Fire()
    {
        ...
        {
            Vector2 shootDirection = facingRight ? bulletPosition.right.normalized : -bulletPosition.right.normalized;
            bulletScript.Initialize(shootDirection, bulletSpeed, bulletMaxDistance);
        }
    }
